...
export const metadata: Metadata = {
  title: 'Gatherly - Scale Your Events with Precision',
  description:
    'Manage registrations, automate attendee approvals, and seamlessly sync with Zoom. Gatherly provides industrial-grade solutions for your event organizer dashboard.',
  keywords: ['event management', 'zoom integration', 'rsvp system', 'online events', 'conference management', 'meetup organizer'],
  openGraph: {
    title: 'Gatherly - High-Fidelity Event Management',
    ...
    url: 'https://gatherlyy.vercel.app/',
    siteName: 'Gatherly',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Gatherly - High-Fidelity Event Management',
      },
    ],
  },
  twitter: {
